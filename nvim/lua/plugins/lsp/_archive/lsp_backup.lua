return {
  {
    ...
    version = "*", -- FIXED: Use stable version instead of false
    lazy = false,
  ...
  ---@type LazyPlugin
  {
    ...
    branch = "master",
    version = "*", -- FIXED: Use stable version
    lazy = false,
    build = ":TSUpdate",
    opts = function(_, opts)
  ...
  {
    "nvimtools/none-ls.nvim", -- NOTE: Consider migrating to conform.nvim + nvim-lint
    optional = true,
    enabled = true,
    dependencies = {
